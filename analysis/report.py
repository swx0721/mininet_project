...
def generate_markdown_report():
    ...
    with open(filepath, "w", encoding="utf-8") as f:
        ...
        f.write("| 区域 | 网段 | 可用地址 |\n")
        f.write("|------|------|----------|\n")
        f.write("| 宿舍区 | 10.0.0.0/20 | ~4,094 |\n")
        f.write("| 教学楼 | 10.0.16.0/20 | ~4,094 |\n")
        f.write("| 图书馆 | 10.0.32.0/23 | ~510 |\n")
        f.write("| 办公楼 | 10.0.34.0/24 | ~254 |\n")
        f.write("| 财务处 | 10.0.35.0/26 | ~62 |\n")
        f.write("| 人事处 | 10.0.35.64/26 | ~62 |\n")
        f.write("| 服务器1 | 10.0.60.0/28 | ~14 |\n")
        f.write("| 服务器2 | 10.0.60.16/28 | ~14 |\n\n")
